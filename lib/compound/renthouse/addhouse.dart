...
class AddHousePageArabic extends StatefulWidget {
  const AddHousePageArabic({super.key});

  @override
  _AddHousePageArabicState createState() => _AddHousePageArabicState();
}

class _AddHousePageArabicState extends State<AddHousePageArabic> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      Map<String, dynamic> houseData = {
        ...
        'insurance': _insuranceController.text.isNotEmpty ? int.parse(_insuranceController.text) : null,
      ...
      try {
        ...
        await supabaseConfig.secondaryClient.from('houses').insert(houseData);
                      ...
                      children: [
                        ...
                        FadeInUp(
                          ...
                          child: _buildDropdownField(
                            ...
                            items: ['6 شهور', 'سنة', 'سنة ونصف', 'سنتين', 'ثلاث سنوات', 'قابل للتفاوض'],
